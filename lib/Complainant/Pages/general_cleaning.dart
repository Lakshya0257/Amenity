...
List<cleaning_complaint> cleaning_complaints = [];
late int touch_cleaning;
late User logged_clean;
                              ...
                              builder: (context, snap) {
                                ...
                                for (var complaints in complaintss) {
                                  ...
                                  if (sender.toString() ==
                                    ...
                                    cleaning_complaints.add(cleaning_complaint(
                                        username,
                                        mobile,
                                        hostel,
                                        block,
                                                  ...
                                                  Row(
                                                    children: [
                                                      ...
                                                      Container(
                                                        ...
                                                        child: TextButton(
                                                            onPressed: () {
                                                              touch_cleaning = index;
                                                              Navigator.of(context).push(MaterialPageRoute(builder: (context)=>complaint_cleaning_display()));
                                                            },
                                                            child: const Text(
                                                              'Details',
                                                              style: TextStyle(
...
class complaint_cleaning_display extends StatelessWidget {
  const complaint_cleaning_display({Key? key}) : super(key: key);
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(cleaning_complaints[touch_cleaning].username,style: styles,),
                        ],
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(cleaning_complaints[touch_cleaning].phone,style: styles,),
                        ],
                      ),
                    ),
                  ),
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(cleaning_complaints[touch_cleaning].hostel,style: styles,),
                            ],
                          ),
                        ),
                      ),
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(cleaning_complaints[touch_cleaning].block,style: styles,),
                            ],
                          ),
                        ),
                      ),
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(cleaning_complaints[touch_cleaning].floor,style: styles,),
                            ],
                          ),
                        ),
                      ),
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(cleaning_complaints[touch_cleaning].room,style: styles,),
                            ],
                          ),
                        ),
                      ),
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(cleaning_complaints[touch_cleaning].cleaningtype,style: styles,),
                        ],
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(cleaning_complaints[touch_cleaning].date,style: styles,),
                        ],
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(cleaning_complaints[touch_cleaning].time,style: styles,),
                        ],
                      ),
                    ),
                  ),
                      ...
                      child: TextButton(
                        ...
                        onPressed: () {
                          FirebaseFirestore.instance
                            ...
                            'sender': logged_clean.email.toString(),
                            'mobile': mobile.text,
