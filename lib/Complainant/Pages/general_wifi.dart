...
List<String> wifi_room_list = [];
List<String> wifi_date_list = [];
List<String> wifi_time_list = [];
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                ...
                                                Text(wifi_room_list[index],style: TextStyle(color: Colors.blueAccent,fontSize: 15),)
                                            ...
                                            Row(
                                              children: [
                                                Text('Preferred Date: ',
                                                  style: TextStyle(color: Colors.blueAccent,fontSize: 15,fontWeight: FontWeight.bold),),
                                                Text(wifi_date_list[index],style: TextStyle(color: Colors.blueAccent,fontSize: 15),)
                                              ],
                                            ),
                                            Row(
                                              children: [
                                                Text('Preffered Timing: ',
                                                  style: TextStyle(color: Colors.blueAccent,fontSize: 15,fontWeight: FontWeight.bold),),
                                                Text(wifi_time_list[index],style: TextStyle(color: Colors.blueAccent,fontSize: 15),)
                                              ],
                                            ),
                                            SizedBox(width: 1,),
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      SizedBox(width:170,
                        height: 50,
                        child: TextFormField(
                          controller: wifi_room_controller,
                          keyboardType: TextInputType.number,
                          decoration:InputDecoration(
                  ...
                  SizedBox(width: 370,
                    height: 50,
                    child: TextFormField(
                      controller: wifi_date_controller,
                  ...
                  SizedBox(width: 370,
                    height: 50,
                    child: TextFormField(
                      controller: wifi_time_controller,
                      keyboardType: TextInputType.datetime,
                      decoration:InputDecoration(
                    ...
                    child: Container(
                      ...
                      child: TextButton(
                        ...
                        onPressed: (){
                          ...
                          wifi_date_list.add(wifi_date_controller.text);
                          wifi_room_list.add(wifi_room_controller.text);
                          wifi_time_list.add(wifi_time_controller.text);
                          wifi_indi++;
